...
const TABLE_HEAD = ["Image", "Product-Name", "Description", "Price", "Cetagory", "Edit"];
              ...
              (
                ...
                return (
                  <tr key={name}>
                    <td className={classes}>
                      <div className="flex items-center gap-3">
                        <Avatar
                          ...
                          alt={name}
                          size="md"
                          className="border-blue-gray-50 bg-blue-gray-50/50 border object-contain p-1"
                        />
                    ...
                    <td className={classes}>
                      <div className="flex items-center gap-3">
                        <div className="border-blue-gray-50 h-9 w-12 rounded-md border p-1">
                          <Avatar
                            src={
                              account === "visa"
